...
<template>
  <div v-if="store.cart.length > 0 ? true : false" class="mt-14 flex justify-around  min-w-100">
    ...
    <div class="min-w-20 border-green-100 rounded-md border-2 bg-green-50 text-green-900 p-20 flex gap-10 flex-col mt-10">
      ...
      <button
            @click="store.startSubscription(SelectedDays, startDate)"
